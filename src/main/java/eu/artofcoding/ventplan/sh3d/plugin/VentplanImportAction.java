...
public class VentplanImportAction extends PluginAction {

    private ResourceBundle resource;

    public VentplanImportAction(ClassLoader classLoader) {
        resource = ResourceBundle.getBundle(
                "com.ventplan.plugin.ApplicationPlugin",
                Locale.getDefault(), classLoader);
        putPropertyValue(Property.NAME, resource.getString("ventplan.import.action.name"));
